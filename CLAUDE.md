Portfolio-wide rules for all Fabric workspaces in this repo.
Read automatically by Claude Code in every session.
Workspace-specific context lives in ws_<name>/CLAUDE.md.
